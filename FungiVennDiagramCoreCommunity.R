...
seperate_table_lot = paste(completetable1$Lotus_Core, completetable1$Lotus_Abundance)
seperate_table_ara = paste(completetable1$Arabidopsis_Core, completetable1$Arabidopsis_Abundance)

seperate_table_ara = as.vector(seperate_table_ara)
seperate_table_lot = as.vector(seperate_table_lot)
...
vennDiagram(completetable2, names = c("Arabidopsis Abundance", "Arabidopsis Core", "Lotus Abundance", "Lotus Core"), cex = c(1, 1, 1), mar = rep(0.5,4), lwd=1, counts.col = "red", circle.col = col)
venn.diagram(completetable, filename="FungiVennDiagram.tiff", height = 3000, width = 5000, fill = col1,
             resolution = 500, imagetype = "tiff", units = "px", compression = "lzw", na = "stop", main = "Venn Diagram Fungi", sub = NULL, main.pos = c(0.5, 1.05), main.fontface = "plain",
             main.fontfamily = "serif", main.col = "black",
             main.cex = 1, main.just = c(0.5, 1), sub.pos = c(0.5, 1.05), sub.fontface = "plain", sub.fontfamily =
               "serif", sub.col = "black", sub.cex = 1, sub.just =
               c(0.5, 1), category.names = c("Arabidopsis Abundance", "Arabidopsis Core", "Lotus Abundance", "Lotus Core"), force.unique =
...
col1 = c("#0F85B0","#FD861E","#F9DA73" , "#16B7B2")
?par
?vennDiagram
?venn.diagram
